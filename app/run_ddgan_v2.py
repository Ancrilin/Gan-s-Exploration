        ...
        for i in range(args.n_epoch):
            ...
            for sample in tqdm.tqdm(train_dataloader):
                ...
                if args.loss == 'v1':
                    ...
                    loss_fake = adversarial_loss_v2(detector(fake_feature), fake_label)
                if args.loss == 'v1':
            ...
            logger.info('[Epoch {}] Train: detector_train_loss: {}'.format(i, detector_train_loss / n_sample))
            logger.info('---------------------------------------------------------------------------')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--detect_dim', type=int, default=512)
    ...
    parser.add_argument('--detector_lr', type=float, default=1e-5)
